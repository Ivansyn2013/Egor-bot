...
MAIN_MENU_ANSWERS = {
    "Консультации": """
    📔 FODMAP методичка (https://t.me/ibs_doc/230) - здесь вы сможете узнать больше о low-FODMAP диете простыми словами, как ее соблюдать, разберетесь, зачем нужны все ее 3 фазы 📲 Онлайн консультации \n(https://t.me/ibs_doc/202)
