...
async def get_product_list_kb(all_product_dict: dict) -> types.InlineKeyboardButton:
    ...
    if len(but_list) > 15:
        ...
        for index in range(0, len(but_list), 14):
            ...
            divided_by_too = [
                but_list_divide[i : i + 2] for i in range(0, len(but_list_divide), 2)
            ]
        ...
        kb_instance = InlineKeyboardMarkup(
            inline_keyboard=[
                inline_but_kb[i : i + 2] for i in range(0, len(inline_but_kb), 2)
            ],
            resize_keyboard=True,
        )
        ...
        kb_list = InlineKeyboardMarkup(
            inline_keyboard=[inline_but_kb], resize_keyboard=True
        )
